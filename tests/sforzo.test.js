...
// Il tasto: solo a tiro fallito, non sforzato, non Scoppio, non vittoria automatica.
...
assert.equal(
  ...
  '<p class="wod5e-mage-roll-note wod5e-mage-roll-note-sforzo"><b class="wod5e-mage-sforzo-label">Sforzare la realtà</b> <span>successi mancanti 3, la Ruota sale di 3 in Paradosso.</span></p>'
);
