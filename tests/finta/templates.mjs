...
const context = {
  ...
  spheres: [{ id: "forces", label: "WOD5E_MAGE.Spheres.forces", icon: "s.png", value: 3, family: true, chosen: true, poteri: [{ id: "forces-1-1", sphere: "forces", sphereLabel: "Forze", dot: 3, type: "passivo", label: "Vestire lo scudo", short: "Vestire lo scudo", text: "Difesa", selected: false }, { id: "forces-1-2", sphere: "forces", sphereLabel: "Forze", dot: 2, type: "passivo", label: "Conduttore", short: "Conduttore", text: "", selected: true }], potere: { id: "forces-1-2", short: "Conduttore" } }, { id: "life", label: "WOD5E_MAGE.Spheres.life", icon: "s.png", value: 0, family: false, chosen: false, poteri: [], potere: null }],
  scopeRows: [{ id: "potency", label: "Potenza", faIcon: "fa-solid fa-burst", level: 4, reading: "Peso: un'auto", mode: "potency", modeLabel: "Peso", modeCount: 3, nextModeLabel: "Epicità", multi: true, modeChosen: true, modeShown: false, modes: [{ id: "potency", label: "Peso", selected: true }, { id: "potencyEpic", label: "Epicità", selected: false }, { id: "potencyDamage", label: "Danni", selected: false }], steps: [1, 2, 3, 4, 5, 6, 7].map((v) => ({ value: v, active: v === 4, lit: v <= 4, reading: `lettura ${v}`, tip: `${v} · lettura ${v}` })) }, { id: "area", label: "Area", faIcon: "fa-solid fa-map", level: 0, reading: "", mode: "area", modeLabel: "", modeCount: 1, nextModeLabel: "", multi: false, modeChosen: true, modeShown: false, modes: [{ id: "area", label: "", selected: true }], steps: [1, 2, 3, 4, 5, 6, 7].map((v) => ({ value: v, active: false, lit: false, reading: `area ${v}`, tip: `${v} · area ${v}` })) }, { id: "duration", label: "Durata", faIcon: "fa-solid fa-hourglass", level: 0, reading: "", mode: "duration", modeLabel: "In gioco", modeCount: 2, nextModeLabel: "Narrativa", multi: true, modeChosen: false, modeShown: false, modes: [{ id: "duration", label: "In gioco", selected: false }, { id: "durationNarrative", label: "Narrativa", selected: false }], steps: [1, 2, 3, 4, 5, 6, 7].map((v) => ({ value: v, active: false, lit: false, reading: "", tip: String(v) })) }],
...
assert.equal((html.match(/data-action="cassettoToggle"/g) ?? []).length, 3, "le tendine: Potenza e Durata dal nome, il potere di Forze");
