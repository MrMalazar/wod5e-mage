...
assert.equal((html.match(/data-action="cassettoToggle"/g) ?? []).length, 5, "le tendine: Potenza, Bersagli e Durata dal nome, il potere di Forze, le Specializzazioni di Velo (1.10.0)");
