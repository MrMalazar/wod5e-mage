...
assert.equal((html.match(/data-action="cassettoToggle"/g) ?? []).length, 2, "il nome apre la tendina solo su chi ha più letture (Potenza e Durata)");
