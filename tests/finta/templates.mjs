...
assert.equal((html.match(/data-action="cassettoToggle"/g) ?? []).length, 3, "il nome apre la tendina solo su chi ha più letture (Potenza e Durata), più «Scegli la lettura» sulla Durata");
