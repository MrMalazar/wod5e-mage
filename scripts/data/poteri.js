...
export const POTERI = Object.freeze([
  {
    ...
    "attivo": "",
    "passivo": "Quando ti nascondi in scena non dichiari dove sei: scegli il punto esatto quando agisci o quando qualcuno ti trova, purché ci potessi arrivare.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Azione minore: recuperi all'istante un oggetto dall'inventario.\nPaga 2 Quintessenza: per una scena la tasca vale anche per un contenitore grande quanto un baule.",
    "passivo": "Accesso con Corrispondenza: nelle tue tasche hai sempre più di quello che la gente possa immaginare: accumuli infiniti oggetti senza considerare il peso, purché entrino nella tasca. Con Corrispondenza 3 valgono anche contenitori come uno zaino. La riserva di spazio è una sola, a prescindere da quanti jeans o zaini cambi. Quello che nascondi nella tasca o in uno spazio piegato, nessun tiro di Allerta o Investigare lo trova; chi lo cerca con la Magick tira all'8 (Tasca doppia).",
    "amalgama": "Con Materia: l'oggetto è troppo grande? Si può ridimensionare: nella tasca entra anche quello che è più grande di lei (un fucile, una sedia, una bicicletta).\nCon Primordio: hai di tutto in tasca, anche quello che non c'era prima: una volta per scena tiri fuori un oggetto comune che non ci avevi messo (una torcia, una corda, un accendino).\nCon Tempo: ma quello non è lo stesso snack di 5 minuti fa? Una volta per scena ritrovi in tasca una cosa che hai appena consumato (lo snack, la sigaretta, la gomma da masticare).",
    "amalgam": "matter",
    "amalgams": [
      "matter",
      "prime",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Un oggetto tuo che perdi o che ti rubano torna da te entro la sessione dopo. Come torna lo decide il Narratore (te lo riporta qualcuno, lo ritrovi dove non l'avevi lasciato, arriva per posta).",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Dai e ricevi dadi di Armonia con compagni che non sono in scena, nei tiri di Abilità. Il tetto di 3 resta.",
    "amalgama": "Con Primordio: i dadi di Armonia a distanza valgono anche nei lanci di Magick.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione dichiari che conosci in città un posto che serve al gruppo (un rifugio, un'uscita sul retro, un passaggio): il Narratore lo fa esistere dove ha senso.",
    "passivo": "",
    "amalgama": "Con Entropia: il posto c'è per caso anche dove non sei mai stato.",
    "amalgam": "entropy",
    "amalgams": [
      "entropy"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena un dettaglio già descritto della pianta del luogo diventa un altro (la porta è una finestra, la scala sta dall'altra parte, il condotto è più largo). Il Narratore adatta il resto della scena.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione il gruppo si rifornisce come se passasse dal Santuario (munizioni, medicine, vestiti).",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione la scena finisce col gruppo già fuori, in salvo. Il Narratore sceglie cosa è rimasto indietro (un oggetto, un indizio, un PNG).",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Quando in un tuo tiro riuscito escono due 10, aggiungi un effetto a scelta: 1 danno in più, una Condizione al bersaglio o un'informazione dal Narratore.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "A inizio sessione tiri un dado e lo metti da parte. Una volta nella sessione, a tiro fatto, lo metti al posto di un dado di chiunque in un tiro di Abilità, anche di un nemico.",
    "passivo": "",
    "amalgama": "Con Primordio: vale anche nei lanci di Magick.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "A inizio sessione scegli un compagno: il Narratore non vi divide in scene diverse se voi non volete.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Quando paghi un Prezzo, il Narratore ti dà anche un piccolo vantaggio (un'informazione, un'occasione, un oggetto).",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Una volta per scena, prima di un tiro di Abilità, dichiari pari o dispari: se il primo dado ti dà ragione hai 2 dadi in più al tuo prossimo tiro, se no 2 in meno.",
    "passivo": "Negli scontri di dadi (iniziativa, contese) vinci i pareggi.",
    "amalgama": "Con Primordio: l'effetto attivo vale anche per i lanci di Magick.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena, quando ti sparano, dichiari che fra te e chi spara c'è qualcosa in mezzo (una colonna, un'auto, un bancone): l'attacco non parte, e per spararti deve prima spendere un'azione a spostarsi.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Segni chi ti ha ferito. Quando lo riaffronti, il Narratore ti dà un vantaggio su di lui (un punto debole, un'occasione, un alleato).",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione un tiro di un'Abilità in cui hai un solo pallino riesce.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "type": "passivo",
    "kind": "passivo",
    "text": "Effetto passivo: Quando a qualcun altro in scena va male un tiro di Abilità, al tuo prossimo tiro di Abilità hai +2 dadi, qualunque sia: non lo scegli tu.\n\nEffetto Amalgama: Accesso con Primordio: quando a qualcun altro in scena scoppia il Paradosso su un tiro di Magick, recuperi 1 Quintessenza, ma prendi anche tu 1 punto di Paradosso.",
    "attivo": "",
    "passivo": "Quando a qualcun altro in scena va male un tiro di Abilità, al tuo prossimo tiro di Abilità hai +2 dadi, qualunque sia: non lo scegli tu.",
    "amalgama": "Con Primordio: quando a qualcun altro in scena scoppia il Paradosso su un tiro di Magick, recuperi 1 Quintessenza, ma prendi anche tu 1 punto di Paradosso.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
    "amalgamText": "Accesso con Primordio: quando a qualcun altro in scena scoppia il Paradosso su un tiro di Magick, recuperi 1 Quintessenza, ma prendi anche tu 1 punto di Paradosso.",
    "flavor": "«Il banco vince sempre.»",
    "cost": "",
    "costValue": 0,
    "uses": null,
    "paradox": "Nessuno effetto attivo, nessun rischio effetto passivo.",
    "formula": "drenare",
    "formulaName": "Drenare",
    "link": "regola",
    "page": "Entropia",
  ...
  },
  {
    ...
    "attivo": "Fra una sessione e l'altra trovi l'oggetto che cerchi. Il Narratore ti dice il prezzo, in soldi o in un favore.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena leghi il tuo tiro di Abilità a quello di un compagno nello stesso turno: fatti i due tiri, tutti e due valgono il migliore.",
    "passivo": "",
    "amalgama": "Con Primordio: vale anche se uno dei due tiri è un lancio di Magick.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione nomini un PNG: salta la scena dopo, e il perché lo decide il Narratore.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione indichi un oggetto in scena: quando lo usi, entro la sessione, il tiro riesce.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena togli un dado riuscito a un tiro di Abilità appena fatto, e lo aggiungi al tuo prossimo tiro.",
    "passivo": "",
    "amalgama": "Con Primordio: vale anche coi lanci di Magick, sia per togliere il dado sia per metterlo.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena, dopo un tiro di Abilità riuscito, ritiri. Se riesci ancora, raddoppia la parte dell'effetto che si conta (i danni, la durata, i bersagli), e cosa si può raddoppiare lo dice il Narratore; se fallisci, perdi anche la prima riuscita.",
    "passivo": "",
    "amalgama": "Con Primordio: vale anche dopo un lancio di Magick riuscito.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena un tiro di Abilità fallito di un compagno diventa riuscito. In cambio, un tuo tiro della sessione fallirà senza tirare, e il Narratore sceglie quale.",
    "passivo": "",
    "amalgama": "Con Primordio: vale anche per i lanci di Magick.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "",
    "amalgama": "Con Primordio: quando prendi Paradosso tiri un dado. Pari non lo prendi tu: va da qualche parte, e il Narratore dice dove. Dispari lo prendi doppio.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione, a inizio scena, scommetti su come finisce (chi vince, chi scappa, cosa si rompe). La posta dipende dalla Sfera d'Amalgama.",
    "passivo": "",
    "amalgama": "Con Primordio: se vinci prendi 3 Quintessenza, se perdi prendi 3 Paradosso.\nCon Materia: se vinci prendi un oggetto, se perdi ne perdi uno.\nvinci una cosa del loro campo, a discrezione del Narratore, e se perdi ne perdi una dello stesso tipo.",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione, quando al gruppo manca una cosa per andare avanti (una chiave, un documento, un pezzo), ce l'hai tu, e il Narratore dice quanto ti è costata.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena un'azione che un nemico ha già fatto nella sessione gli fallisce, senza tiro.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "A inizio sessione il Narratore ti dà tre carte: una persona, un luogo, un evento. Una volta nella sessione ne giochi una, e il Narratore la mette in scena.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione scambi l'esito del tuo tiro di Abilità con quello di un altro in scena, anche di un nemico.",
    "passivo": "",
    "amalgama": "Con Primordio: vale anche per i lanci di Magick.",
    "amalgam": "prime",
    "amalgams": [
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Quando un tuo colpo non fa danni, puoi barattare la sua Potenza con la Condizione stordito: il bersaglio resta stordito 1 turno per livello di Potenza.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Quando un compagno vicino a te viene attaccato, ti metti in mezzo: l'attacco prende te al posto suo.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "I danni da fuoco o da elettricità che fai continuano: ogni turno il bersaglio prende la metà del danno di partenza, per difetto, finché non spende un'azione per spegnersi.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "I danni dei tuoi lanci di Forza non si curano con Medicina fino a fine scena.",
    "amalgama": "Con Vita: non guariscono neanche da sole, col riposo o con le rigenerazioni, fino a fine scena.\nCon Primordio: non si curano neanche con la Magick fino a fine scena.",
    "amalgam": "prime",
    "amalgams": [
      "prime",
      "life"
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Quando un nemico prova a lasciare la scena, un tuo colpo riuscito lo tiene in scena.\nAccesso con Forza: lo butti giù o gli sbarri la strada.\nAccesso con Corrispondenza: la via di fuga non porta fuori.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Quando un tuo colpo manda a terra il bersaglio, il danno che avanza passa al più vicino.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "I danni dei tuoi lanci di Forza o di Materia ignorano armature e riduzioni.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "I danni dei tuoi lanci di Forza con Potenza 3 o più sono aggravati.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Una volta per scena paga 1 Quintessenza: metti insieme due oggetti in scena e ne fai uno che serve (una fionda, un grimaldello, un fumogeno), senza tirare.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per scena, se l'attrezzo che usi c'entra col tiro (un piede di porco, un grimaldello, un bisturi), non paghi il Prezzo della riuscita.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Un oggetto che impugni fa i danni di un'arma vera della sua misura (una bottiglia come un coltello, una sedia come una mazza, un ombrello come un bastone).",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Fra una sessione e l'altra un oggetto fatto da te prende una qualità: non si inceppa, non si trova o non si rompe.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "",
    "amalgama": "Con Primordio: una volta per sessione, quando un Contraccolpo scoppia, l'Ustione va su un oggetto importante per il personaggio (un ricordo, un'arma di famiglia, il suo Strumento). L'oggetto si distrugge, e non si potrà mai più ricreare.",
    "amalgam": "prime",
    "amalgams": [
      "prime"
    ],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione, in un tiro di conoscenza, hai 3 dadi in più.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione un PNG appena entrato in scena è qualcuno che conosci già; il Narratore dice da dove.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Una volta per sessione il personaggio sa una cosa che sai tu giocatore.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "Quando un compagno che vedi prende una Condizione, la prendi tu al posto suo.\nAccesso con Mente: le Condizioni mentali.\nAccesso con Vita: le Condizioni fisiche.\nAccesso con Spirito: le Condizioni soprannaturali.",
    "passivo": "",
    "amalgama": "prendi le Condizioni di tutti i loro tipi.",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Se nella sessione il personaggio ha una scena di pace (una preghiera, una cena, un luogo sacro), a fine sessione:\nAccesso con Mente: recupera tutta la Volontà.\nAccesso con Spirito: cura una Macchia.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Chi mangia alla tua tavola non ti attacca finché non è uscito di casa tua.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "Una volta per scena spieghi al tavolo il ragionamento che risolve il problema per un'altra strada: se regge, tiri con l'Abilità di quella strada al posto di quella chiesta.",
    "passivo": "",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Quando prendi danni mentali, puoi prendere una Condizione (arrabbiato, distratto, scosso) al posto dei danni.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Un tuo tiro sociale riuscito può infliggere una Condizione mentale (spaventato, confuso, ossessionato), senza Magick.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Un oggetto che porti da almeno una sessione diventa una reliquia: finché lo porti, ti protegge da una Condizione che scegli tu. Se lo perdi, perdi 1 Volontà.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Una Condizione fisica che hai già preso nella sessione non la prendi più fino a fine sessione.",
    "amalgama": "",
    "amalgam": "",
    "amalgams": [],
    "amalgamText": "",
  ...
  },
  {
    ...
    "attivo": "",
    "passivo": "Accesso con Mente: quando sei sotto metà Salute, i lanci di Mente su te stesso hanno soglia meno 2 e le Condizioni mentali pregresse vengono ignorate per la scena.\nAccesso con Spirito: quando sei sotto metà Salute, i lanci di Spirito su te stesso hanno soglia meno 2 e le Condizioni soprannaturali pregresse vengono ignorate per la scena.\nAccesso con Vita: quando sei sotto metà Salute, i lanci di Vita su te stesso hanno soglia meno 2 e le Condizioni fisiche pregresse vengono ignorate per la scena.",
